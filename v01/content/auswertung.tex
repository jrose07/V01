...
\begin{table}[H]
    \centering
    \caption{Zählraten der Koinzidenz in Abhängigkeit der eingestellten Verzögerungszeit $\Delta t$ an der linken bzw. rechten Verzögerungsleitung.}
    \label{tab:delay}
    \begin{tabular}{S[table-format=2.0] S[table-format=3.0] S[table-format=3.0]}
        \toprule
        {$\Delta t \: / \: \unit{\nano\second}$} & {$N_{\text{links}}$} & {$N_{\text{rechts}}$} \\
        \midrule
        0  & 345 & {--} \\
        2  & 351 & 332 \\
        4  & 334 & 361 \\
